...
| 문서 | 무엇 |
|---|---|
| [`SPEC.md`](SPEC.md) | **지금 코드에 있는 것.** 화면 7개·컴포넌트·시각 언어 실측값·카피 전문 |
| [`DESIGN.md`](DESIGN.md) | **앞으로 그렇게 만들 것.** 디자인 결정서 (2026-09-22). 둘이 어긋나면 이쪽이 최신 |
| [`../docs/designs/color-moments.md`](../docs/designs/color-moments.md) | 기획·근거·기각된 안 |
