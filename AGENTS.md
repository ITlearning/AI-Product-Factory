...
| doc-lint | 문서 전용 변경 검증 규칙 | [`docs/harness/doc-lint.md`](docs/harness/doc-lint.md) |
...
| docs/planning 파일만 변경 | [`docs/harness/doc-lint.md`](docs/harness/doc-lint.md) 수동 체크리스트 수행 |
