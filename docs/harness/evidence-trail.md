...
| 문서 | 관계 |
|------|------|
| [`docs/harness/CHARTER.md`](CHARTER.md) | Review Gates (evidence가 리뷰 판정의 근거) |
| [`docs/harness/ralplan-ralph.md`](ralplan-ralph.md) | ralph 실행 사이클 (검증→리뷰 단계에서 evidence 생성) |
...
| [`docs/harness/spec-lock.md`](spec-lock.md) | 잠금 해제 시 기록의 evidence 저장 |
| [`AGENTS.md`](../../AGENTS.md) | Validation 테이블 (서비스별 검증 명령) |
| [`docs/harness/doc-lint.md`](doc-lint.md) | 문서 전용 변경 검증 규칙 (검증 결과를 evidence로 기록) |
